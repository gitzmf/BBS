...
public class ArticleAssist implements Serializable{
    /**
	 * 
	 */
    ...
    public ArticleAssist() {
		super();
	}

	public ArticleAssist(Integer fid, String titles, String fcontent, String bname, String time, Integer userid,
