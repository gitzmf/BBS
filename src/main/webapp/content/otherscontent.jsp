				...
				<div class="row">
					<div class="col-md-2">
						...
						<c:if test="${othersListUser.userphoto!=null }">
							<img class="img-thumbnail"
								style="position: relative; width: 140px; height: 140px; left: 10px; top: -20px;"
								src="${basepath }/userimg/${othersListUser.userphoto }">
						</c:if>
					</div>
					<div class="col-md-8">
						<div class="row">
									...
									<div class="row">
										...
										<div class="col-xs-12 col-md-12">
											<c:if test="${othersListArticle.photo!=\"photo\" }">
												<a href="${basepath }/userarticle/${othersListArticle.photo }" target="_blank">
													<c:if test="${othersListArticle.photo.endsWith(\".mp4\")||othersListArticle.photo.endsWith(\".avi\") }">
														<video controls="controls" src="${basepath }/userarticle/${othersListArticle.photo }"
															style="position: relative; width: 30%; height: 30%;"></video>
													</c:if>
													<c:if test="${!othersListArticle.photo.endsWith(\".mp4\")&&!othersListArticle.photo.endsWith(\".avi\") }">
														<img src="${basepath }/userarticle/${othersListArticle.photo }"
