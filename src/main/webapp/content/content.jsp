...
<body>
										...
										<div class="row">
											<div class="col-xs-2 col-md-1">
												<a href="${APP_PATH}/userController/getOthers?userid=${listArticle.userid }"> 
													...
													<c:if test="${listArticle.userphoto != null }">
														<img class="img_head" alt="Brand" src="${basepath }/userimg/${listArticle.userphoto }">
													</c:if>
													<%-- <a>头像:${listArticle.userphoto }</a> --%>
												</a>
											</div>
										...
										<div class="row">
											<div class="col-md-12">
												<c:if test="${listArticle.photo!=\"photo\" }">
													<a href="${basepath }/userarticle/${listArticle.photo }" target="_blank">
														<c:if test="${listArticle.photo.endsWith(\".mp4\")||listArticle.photo.endsWith(\".avi\") }">
															<video class="img_content" controls="controls"
																src="${basepath }/userarticle/${listArticle.photo }"></video>
														</c:if>
														<c:if test="${!listArticle.photo.endsWith(\".mp4\")&&!listArticle.photo.endsWith(\".avi\") }">
															<img class="img_content"
																src="${basepath }/userarticle/${listArticle.photo }">
														</c:if>
													</a>
												</c:if>
											</div>
											...
											<div class="col-xs-10 col-md-6">
												...
												<div class="col-xs-7 col-md-6">
													...
													<c:if test="${!empty username && listArticle.username!=username }">
														...
														<!-- 判断collect_record中是否有“false”，有表示该帖子对应的用户还没有被收藏 -->
	...
	<script src="${APP_PATH }/static/js/phones_pc.js" charset="UTF-8"></script>
	<script src="${APP_PATH }/static/js/load_more.js" charset="UTF-8"></script>
